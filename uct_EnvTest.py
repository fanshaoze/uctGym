...
class UCTPlanner(object):
    ...
    def __init__(self, _sim, _maxDepth, _numRuns, _ucbScalar, _gamma, _leafValue, _endEpisodeValue, _deterministic):
    ...
    def plan(self):
        ...
        if rootOffset == 0:
            ...
            rootOffset += 1
        # nodeList.append(self.root_) #for viz
        # print("rootOffset:",rootOffset,"numRuns_",self.numRuns_)
            ...
            while True:
                ...
                if current.isFull():
                    ...
                    if self.deterministic_ is True:
                        current = current.nodeVect_[uctBranch].stateVect_[0]
                        continue
                    else:
